/***********************************************
 * The ITM software was developed by NTIA.
 * The NTIA does not make any warranty of 
 * any kind, express, implied or statutory, 
 * including, without limitation, the 
 * implied warranty of merchantability, 
 * fitness for a particular purpose, 
 * non-infringement and data accuracy. NTIA
 * does not warrant or make any representations 
 * regarding the use of the software or the 
 * results thereof, including but not limited 
 * to the correctness, accuracy, reliability or
 * usefulness of the software or the results. 
 * You can use, copy, modify, and redistribute 
 * the NTIA-developed software upon your 
 * acceptance of these terms and conditions and 
 * upon your express agreement to provide 
 * appropriate acknowledgments of NTIA's 
 * ownership of and development of the software 
 * by keeping this exact text present in any 
 * copied or derivative works.
 *
		...
		prop_type &prop, propa_type &propa)  // PaulM_lrprop
{
	 ...
	 *  that when one uses the area mode, one will want a sequence of results
